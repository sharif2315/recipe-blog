...
Revision ID: 8f67ea8803bd
Revises: 
Create Date: 2026-09-09 13:09:17.602300
...
def upgrade():
    ...
    sa.Column('duration', sa.Numeric(precision=10, scale=1), nullable=False),
    sa.Column('difficulty', sa.Enum('BEGINNER', 'INTERMEDIATE', 'ADVANCED', name='recipedifficulty'), nullable=True),
    sa.Column('servings_text', sa.String(length=60), nullable=False),
